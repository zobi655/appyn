...
class Windows10GeneralConfiguration extends DeviceConfiguration
{
    ...
    */
    public function getDefenderScanDownlopx_ads()
    {
    ...
    * @return Windows10GeneralConfiguration
    */
    public function setDefenderScanDownlopx_ads($val)
    {
    ...
    */
    public function getStartMenuPinnedFolderDownlopx_ads()
    {
    ...
    * @return Windows10GeneralConfiguration
    */
    public function setStartMenuPinnedFolderDownlopx_ads($val)
    {
